...
Revision ID: 1172760b20de
Revises: 
Create Date: 2026-01-14 13:54:15.015515
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_batches_is_closed'), 'batches', ['is_closed'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_batches_is_closed'), table_name='batches')
